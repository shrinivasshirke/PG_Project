...
export const About = ()=>{
    ...
    <><div>
            ...
            <p style={{ color: "#961e1b", marginTop: "70px", marginLeft: "70px", textAlign: "left" }}>About Redwings.com</p>
            <hr
                style={{
                    color: "black",
                    height: 5
        ...
        <Container style={{ backgroundColor: "lightgrey" }} className="info1">
        		<h1 style={{marginTop:"20px"}}>Redwings.com: A Blood Bank Management System</h1>
         ...
         <Container style={{ backgroundColor: "lightgray",textAlign:"justify" }} className="info1">
			...
			<p  style={{fontSize:"20px"}}>
				<b>Redwings.com has six major components for management of the
